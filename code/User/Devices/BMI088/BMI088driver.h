...
// Temperature compensation (tune slopes after measuring drift)
#ifndef BMI088_TEMP_COMP
#define BMI088_TEMP_COMP 1
#endif
#ifndef BMI088_TEMP_DEBUG
#define BMI088_TEMP_DEBUG 1
#endif
#define BMI088_GYRO_TEMP_SLOPE_X 0.0f  // rad/s per C
#define BMI088_GYRO_TEMP_SLOPE_Y 0.0f
#define BMI088_GYRO_TEMP_SLOPE_Z 0.0f
...
#define GxOFFSET 0.002877f
#define GyOFFSET 0.002099f
#define GzOFFSET 0.001005f
#define AxOFFSET -0.234245f
#define AyOFFSET -0.080120f
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.805053f
